...
<html lang="en">
  ...
  <body>
    <section id="header" style="padding-top: 12px; padding-bottom: 12px;">
      ...
      <div>
        <ul id="navbar">
          <li><a class="active" href="indexu.php">Home</a></li>
    ...
    <section id="hero">
      ...
      <button class="submit" onclick="window.location.href='shop.php';">Shop Now</button>
    </section>
    ...
    <section id="sm-banner" class="section-p1">
      ...
      <div class="banner-box banner-box2">
        ...
        <span>The best Sneakers in on sale at yunjac's</span>
        <button class="white" onclick="window.location.href='shop.php';">Collection</button>
      </div>
    </section>
